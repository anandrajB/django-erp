...
model_list = {'user_role': UserRole, 'department': Department,
              'sub_division': Sub_division, 'branch': Branch, 'user': User,
              'partytype': PartyType, 'country': Country, 'parties': Parties,
              'product': Product, 'rawmaterials': Rawmaterials,
              'billofmaterials': BillOfMaterials, 'productionphases': ProductionPhases,
